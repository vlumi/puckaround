...
- **The centre ring is the menu.** Tap the middle of the table any time — mid-game or between games — for Resume or Quit to menu. One neutral control that belongs to neither player, so leaving never means going through a restart.
