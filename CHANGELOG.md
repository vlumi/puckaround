...
- **Turn the phone sideways and the table fills the screen.** In landscape the board rotates to fill the whole screen instead of sitting as a thin strip between big black bars — the two players sit along the long edge and see an upright table. Touch, mallets and play are unchanged; it's the same game, just using the room it's given.
