...
- **Practice against the machine.** The title's third mode: you take the bottom end while a mallet on a fixed metronome sweep defends the top goal — a drill target, not an AI. It never aims, but its deflections count, so careless shots come back at you. Normal scoring, and the setup's pucks and walls apply — first to 7 against the wiper, three triangles on a wrap table if that's your idea of practice.
