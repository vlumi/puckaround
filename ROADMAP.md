...
- [x] **Survival.** Shipped: the practice machine sweeps its goal while a `PuckFeed` beams in one more puck every few seconds (shapes cycling, capped at three) and the pace climbs with the clock, forever; living pays 10 a second, drains cost lives directly. The arcade's launch trio is complete.
