...
bundle_id="fi.misaki.puckaround"
derived=".build-xcode"
...
echo "Building Puckaround-iOS..."
xcodebuild -project Puckaround.xcodeproj -scheme Puckaround-iOS \
...
# is "Puck Around" (PRODUCT_NAME), and this survives future renames.
