...
/// arcade run: bumpers pay, a goal into the far end pays big, and draining
/// your own goal costs a life — the run ends at zero. The sim itself never
/// ends an arcade game (its points target is set out of reach); this is what
/// does. The player always defends the bottom end.
